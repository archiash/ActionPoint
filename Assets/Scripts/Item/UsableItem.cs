...
[CreateAssetMenu(menuName = "Item/Useable", fileName = "New Useable")]
public class UsableItem : Item
{
    public abstract class UsageEffect : ScriptableObject
    {
        ...
        public abstract bool Use(Status user,object source = null);
    }

    public List<UsageEffect> UsageEffects;

    public override bool UseItem (Status user)
    {
        bool wasUsed = false;
        foreach(var effect in UsageEffects)
        {
            wasUsed |= effect.Use(user,this);
        }
        return wasUsed;
    }
}
...
public class UsableItemEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            Inventory.instance.GetItem(m_Target);
        }
